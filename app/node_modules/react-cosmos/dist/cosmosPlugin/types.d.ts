...
export type CosmosConfigPlugin = (args: CosmosConfigPluginArgs) => Promise<CosmosConfig> | CosmosConfig;
...
export type DevServerPluginReturnValue = void | null | DevServerPluginCleanupCallback;
export type DevServerPluginReturn = DevServerPluginReturnValue | Promise<DevServerPluginReturnValue>;
export type DevServerPlugin = (args: DevServerPluginArgs) => DevServerPluginReturn;
